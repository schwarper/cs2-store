...
public class Store_RouletteConfig : BasePluginConfig
{
    ...
    public Dictionary<string, int> Magenta { get; set; } = new Dictionary<string, int>
    {
        { "multiplier", 5 },
        { "probability", 13 }
    };
    ...
    public Dictionary<string, int> Gold { get; set; } = new Dictionary<string, int>
    {
        { "multiplier", 50 },
        { "probability", 2 }
    };
...
{
    public override string ModuleName => "[Store Module] Mega Roulette";
    public override string ModuleVersion => "0.0.1";
    public override string ModuleAuthor => "rodopoulos, schwarper";
    ...
    public List<Color> Colors = [Color.Red, Color.Blue, Color.Magenta, Color.Gold];
    ...
    public override void OnAllPluginsLoaded(bool hotReload)
    {
        ...
        {
            AddCommand(command, "MegaRoulette", Command_Roulette);
        }
    ...
    public void OnConfigParsed(Store_RouletteConfig config)
    {
        ...
        UpdateMultiplierAndProbability(config.Magenta);
        UpdateMultiplierAndProbability(config.Gold);
    ...
    public void Command_Roulette(CCSPlayerController? player, CommandInfo info)
    {
        ...
        using (new WithTemporaryCulture(player.GetLanguage()))
        {
            ...
            AddRouletteOption(menu, info, credits, Color.Magenta, Config.Magenta["multiplier"]);
            AddRouletteOption(menu, info, credits, Color.Gold, Config.Gold["multiplier"]);
    ...
    {
        int totalProbability = Config.Red["probability"] + Config.Blue["probability"] + Config.Magenta["probability"] + Config.Gold["probability"];
        ...
        else if (randomNumber <= Config.Red["probability"] + Config.Blue["probability"] + Config.Magenta["probability"])
        {
            GiveCreditsToWinner(Color.Magenta);
        }
        else
        {
            GiveCreditsToWinner(Color.Gold);
        }
    ...
    public static char FindChatColor(Color color)
    {
        ...
        return knowncolor switch
        {
            ...
            KnownColor.Magenta => ChatColors.Magenta,
            KnownColor.Gold => ChatColors.Gold,
            _ => ChatColors.White
        };
    }
    ...
    public int FindMultiplier(Color color)
    {
        ...
        return knowncolor switch
        {
            ...
            KnownColor.Magenta => Config.Magenta["multiplier"],
            KnownColor.Gold => Config.Gold["multiplier"],
            _ => ChatColors.White
        };
    }
